...
class CModelSBPlasticConcrete : public CSolidBondModel
{
public:
	CModelSBPlasticConcrete();
	...
	void CalculateSBForceGPU(double _time, double _timeStep, const SGPUParticles& _particles, SGPUSolidBonds& _Bond) override;
};