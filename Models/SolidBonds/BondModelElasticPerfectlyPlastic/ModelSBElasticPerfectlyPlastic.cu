...
#include "ModelSBElasticPerfectlyPlastic.cuh"
...
void CModelSBElasticPerfectlyPlastic::SetParametersGPU(const std::vector<double>& _parameters, const SPBC& _pbc)
{
...
__global__ void CUDA_CalcSBForce_EPP_kernel(
	double	_time,
	double	_timeStep,
