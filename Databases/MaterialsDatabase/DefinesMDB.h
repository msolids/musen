...
#define _MUSEN_ACTIVE_PROPERTIES { PROPERTY_DENSITY, PROPERTY_HEAT_CAPACITY, PROPERTY_DYNAMIC_VISCOSITY, PROPERTY_THERMAL_CONDUCTIVITY, PROPERTY_YOUNG_MODULUS, PROPERTY_NORMAL_STRENGTH, PROPERTY_TANGENTIAL_STRENGTH, PROPERTY_POISSON_RATIO, \
