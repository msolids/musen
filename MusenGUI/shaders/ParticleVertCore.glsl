...
out highp vec3 v_position;			// particle center position in eye space coordinates for fragment shader
out highp vec4 v_color;				// color of particle for fragment shader
out highp float v_radius;			// radius of particle for fragment shader
