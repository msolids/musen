...
void MusenGUI::InitializeConnections()
{
	...
	connect(ui.actionSaveAs,                      &QAction::triggered, this,                         &MusenGUI::SaveSystemStructureAs);
	connect(ui.actionImportFromText,              &QAction::triggered, this,                         &MusenGUI::LoadSystemStructureFromText);
	connect(ui.actionImportFromEDEM,              &QAction::triggered, this,                         &MusenGUI::LoadSystemStructureFromEDEM);
	connect(ui.actionExportGeometries,            &QAction::triggered, this,                         &MusenGUI::ExportGeometriesAsSTL);
	connect(ui.actionSaveAsImage,                 &QAction::triggered, this,                         &MusenGUI::SaveAsImage);
	connect(ui.actionExit,                        &QAction::triggered, this,                         &MusenGUI::close);
	connect(ui.actionWatchOnYoutube,              &QAction::triggered, this,                         &MusenGUI::WatchOnYouTube);
	connect(ui.actionClearTimePoints,             &QAction::triggered, this,                         &MusenGUI::ClearAllTimePoints);
	connect(ui.actionDeleteAllParticles,          &QAction::triggered, this,                         &MusenGUI::DeleteAllParticles);
	connect(ui.actionDeleteNonConnectedParticles, &QAction::triggered, this,                         &MusenGUI::DeleteAllNonConnectedParticles);
	connect(ui.actionDeleteSeparateParticles,     &QAction::triggered, this,                         &MusenGUI::DeleteAllSeparateParticles);
	connect(ui.actionDeleteAllBonds,              &QAction::triggered, this,                         &MusenGUI::DeleteAllBonds);
	connect(ui.actionSaveSnapshot,                &QAction::triggered, this,                         &MusenGUI::SaveSnapshot);
	...
	{
		connect(this,                   &MusenGUI::NewSystemStructureGenerated,           tab, &CResultsAnalyzerTab::UpdateSettings);
	...
	for (auto& tab : m_vpDialogTabs)
	{
		...
		connect(this,                 &MusenGUI::NewSystemStructureGenerated,                  tab,               &CMusenDialog::UpdateWholeView);
		connect(this,                 &MusenGUI::NewSystemStructureGenerated,                  tab,               &CMusenDialog::NewSceneLoaded);
	...
	connect(m_pSimulatorTab,    &CSimulatorTab::SimulatorStatusChanged,  this, &MusenGUI::EnableControlsSimulation);
	connect(m_pExportAsTextTab, &CExportAsTextTab::RunningStatusChanged, this, &MusenGUI::EnableControlsSimulation);

	// materials database
	connect(m_pMaterialDatabaseTab, &CMaterialsDatabaseTab::MaterialDatabaseFileWasChanged,  this,                 &MusenGUI::SaveConfiguration);
	...
	connect(m_pMaterialEditorTab,   &CMaterialsDatabaseLocalTab::MaterialDatabaseWasChanged, this,                 &MusenGUI::UpdateMaterialsInSystemStructure);
	...
	// time management
	connect(ui.timeSlider,   &CTimeSliderTab::NewTimeSelected,          this,          &MusenGUI::ChangeCurrentTime);
	connect(this,			 &MusenGUI::NumberOfTimePointsChanged,      ui.timeSlider, &CTimeSliderTab::SetTimeSliderEnabled);
	connect(m_pSimulatorTab, &CSimulatorTab::NumberOfTimePointsChanged, ui.timeSlider, &CTimeSliderTab::SetTimeSliderEnabled);

	connect(m_pFileMergerTab, &CFileMergerTab::LoadMergedSystemStrcuture,               this, &MusenGUI::LoadFromFile);
	...
	connect(this,                 &MusenGUI::NewSystemStructureGenerated,                  m_pViewManager,      &CViewManager::UpdateAllObjects);
...
void MusenGUI::CreateRecentFilesMenu()
{
	...
	for (int i = 0; i < MAX_RECENT_FILES; ++i)
	{
		...
		connect(action, &QAction::triggered, this, &MusenGUI::LoadRecentFile);
...
void MusenGUI::UpdateRecentFilesMenu()
{
...
void MusenGUI::CreateHelpAction(const QString& _path, const QString& _name, QMenu* _menu)
{
...
void MusenGUI::NewSystemStructure()
{
...
void MusenGUI::SaveSystemStructure()
{
	if (m_sFileName.isEmpty())
...
void MusenGUI::SaveSystemStructureAs()
{
...
void MusenGUI::SaveSystemStructureUtil(const QString& _fileName)
{
...
void MusenGUI::LoadFromFile(const QString& _fileName)
{
	if (_fileName.isEmpty()) return;
	LoadSystemStructureUtil(_fileName);
}

void MusenGUI::LoadRecentFile()
{
...
void MusenGUI::LoadSystemStructure()
{
...
void MusenGUI::LoadSystemStructureUtil(const QString& _fileName)
{
...
void MusenGUI::LoadSystemStructureFromText()
{
...
void MusenGUI::LoadSystemStructureFromEDEM()
{
...
bool MusenGUI::LockFile(const QString& _fileName)
{
...
void MusenGUI::UpdateMaterialsInSystemStructure()
{
	m_SystemStructure.UpdateAllObjectsCompoundsProperties();
}

void MusenGUI::ClearSystemStructure()
{
...
void MusenGUI::ClearAllTimePoints()
{
...
void MusenGUI::DeleteAllParticles()
{
...
void MusenGUI::DeleteAllSeparateParticles()
{
...
void MusenGUI::DeleteAllNonConnectedParticles()
{
...
void MusenGUI::ExportGeometriesAsSTL()
{
...
void MusenGUI::LoadConfiguration()
{
...
void MusenGUI::SetCurrentFile(const QString& _fileName)
{
...
void MusenGUI::UpdateWindowTitle()
{
...
void MusenGUI::EnableControlsNoFile(bool _bEnable) const
{
...
void MusenGUI::EnableControlsSimulation(ERunningStatus _simStatus) const
{
...
void MusenGUI::CenterView(ECenterView _type /*= ECenterView::AUTO*/) const
{
...
void MusenGUI::closeEvent(QCloseEvent* _event)
{
...
void MusenGUI::keyPressEvent(QKeyEvent* _event)
{
...
void MusenGUI::showEvent(QShowEvent* _event)
{
